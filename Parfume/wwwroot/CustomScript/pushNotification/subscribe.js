var applicationServerPublicKey = $('#VapidPublicKey').val();
var serviceWorker = '/parfume.js?v=6.6';
    ...
    navigator.serviceWorker.ready.then(function (reg) {
        ...
        reg.pushManager.subscribe(subscribeParams)
            .then(function (subscription) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/Account/SubscribePushNotification',
                    data: { PushEndPoint: subscription.endpoint, P256dh: p256dh, Auth: auth },
                    success: function (response) {
                        if (response) {
                            alert('Əməliyyat uğurla yerinə yetirildi.', 'Bildiriş');
                        } else {
                            alert('Zəhmət olmasa yenidən cəhd edin.', 'Bildiriş');
                        }
                    }
                });
            })
